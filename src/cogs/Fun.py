...
class Fun(commands.Cog):
    ...
    @commands.hybrid_command(
        ...
        description="Provides a random fact using requests",
    )
    ...
    @commands.hybrid_command(
        ...
        description="Tells you your masculine and feminine percentage",
    )
    async def get_personality_test(self, ctx, member: discord.Member = None):
        ...
        try:
            ...
            if main_array.get("name", None) is not None:
            ...
            embed = create_embed(
                "Error",
                "User is unregistered. Please register by running the " "!register command",
            )
            await ctx.send(embed=embed)
